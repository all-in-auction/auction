...
public class RabbitMQConst {
    ...
    public static final String AUCTION_QUEUE_1 = AUCTION_QUEUE_PREFIX + 1;
    public static final String AUCTION_QUEUE_2 = AUCTION_QUEUE_PREFIX + 2;
    public static final String AUCTION_QUEUE_3 = AUCTION_QUEUE_PREFIX + 3;

    public static final String[] queueNames
            = new String[]{AUCTION_QUEUE_1, AUCTION_QUEUE_2, AUCTION_QUEUE_3};
